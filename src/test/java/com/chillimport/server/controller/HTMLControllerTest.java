...
public class HTMLControllerTest {
	...
	public void websitePreview() throws Exception {
		...
		MvcResult result = this.mvc.perform(post("/websitepreview").param("s", content)).andDo(print())
	...
	public void returnFile() throws Exception {
		...
		MvcResult result = this.mvc.perform(get("/errors/returnFiles")).andDo(print()).andExpect(status().isOk())
				.andReturn();
	...
	public void pingFROSTServer() throws Exception {
		...
		MvcResult result = this.mvc.perform(get("/server-check").param("frostUrl", FrostSetup.getFrostURL()))
				.andDo(print()).andExpect(status().isOk()).andExpect(content().string("Server reachable")).andReturn();
	...
	public void downloadFile() throws Exception {
		...
		MvcResult result = this.mvc
				.perform(get("/get-return").param("fileName", "testfile").accept("application/octet-stream"))
	...
	public void getFrostServerURL() throws Exception {
		...
		MvcResult result = this.mvc.perform(get("/getfrosturl").param("urlasString", url)).andDo(print())
				.andExpect(status().isOk()).andReturn();
	...
	public void delFileInvalid() throws Exception {
		...
		MvcResult result = this.mvc.perform(get("/errors/delFile").param("name", "invalidname")).andDo(print())
