 ...
 * @param tableId id of the table, here it is always the same
 * @param size1 size of the first column
 * @param size2 size of the 2nd column
 ...
 * @param mapping the row of the mapping
 */
