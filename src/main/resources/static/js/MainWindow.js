...
function saveConfig() {
  ...
  $("#datastreams").find(".datastream").each(function() {
    ...
    if (currentInput == null || currentInput == "") {
      $.notify({message : "Please leave no datastream empty."}, {
        allow_dismiss : true,
        type : "info",
        placement : {from : "top", align : "left"},
...
function importData() {
  ...
  if ($("#selecttime option:selected").attr("data-value") === null) {
    $.notify({message : "Please choose a time zone before importing data."}, {
      type : "info",
      placement : {from : "top", align : "left"},
      animate : {enter : "animated fadeInDown", exit : "animated fadeOutUp"}
    });
    ...
    $.notify({message : "Please add a datastream before importing data."}, {
      type : "info",
      placement : {from : "top", align : "left"},
      animate : {enter : "animated fadeInDown", exit : "animated fadeOutUp"}
    });
    ...
    $.ajax({
      ...
      success : function(e) {
        addToLog(e);
        $.notify({message : "Import finished"}, {
          type : "success",
          allow_dismiss : true,
          placement : {from : "top", align : "left"},
          animate : {enter : "animated fadeInDown", exit : "animated fadeOutUp"}
      ...
      error : function(e) {
        $.notify({message : "Import failed. Check log for errors."}, {
          type : "danger",
          allow_dismiss : true,
          placement : {from : "top", align : "left"},
          animate : {enter : "animated fadeInDown", exit : "animated fadeOutUp"}
